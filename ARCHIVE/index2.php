...
$pass = "kjfs923";
$dbname = "upaccinema";
$link = mysql_connect("cinema.union.rpi.edu", $user, $pass);
 ...
 <tr>
  ...
  <td class="links">
   ...
   <!-- <tr><td class="links">>Join UPAC Cinema</td></tr>-->
    ...
    <tr><td class="links">><a href="http://cinema.union.rpi.edu/officers.html">Contact an Officer</a></td></tr>
	<tr><td class="links">><a href="http://cinema.union.rpi.edu/board/">Feedback Forum</a></td></tr>
   </table>
  </td>
  <td class="bv">&nbsp</td>
 </tr>
  ...
  <td class="cencontent">
   <?
	...
	#will be shown on the site.
        $semesters = array();
        $semesters["F04B"] = array(
				   'title'=>'Fall 2004 Second Half',
				   'days'=>array('Wednesday', 'Friday', 'Saturday'),
				   );
   ...
   <center><table class="schedule" align="center">
	...
	<?if ($i % count($days) == 0 ){ echo "<tr>\n"; } ?>
		...
		<? } else { ?>
		<td class="schedule">
			<a href="http://www.imdb.com/title/<?=$movie['imdb']?>/" target="_blank"><?=stripslashes($movie['title'])?></a>
