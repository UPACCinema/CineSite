...
if (!($dbh = DBI->connect("DBI:mysql:upaccinema:ruweb1.union.rpi.edu", "upaccinema", "kjfs923"))){
    sqlerr("(No SQL)");
}
...
<form method="post" action="http://cinema.union.rpi.edu/mahjong/scores2.cgi">
    <table id="addnew">
    <tr>
...
if ($col eq 'scorea'){
    print qq(<b>Method A Scoring</b> - <a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?meth=B">Method B Scoring</a>\n);
} else {
    print qq(<a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?meth=A">Method A Scoring</a> - <b>Method B Scoring</b>\n);
}
print "<table id=\"scores\" cellspacing=0>\n";
print <<TR;
<tr>
  <th>
    <a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?sort=name&meth=$meth&startsem=$startsem&startyear=$startyear&endsem=$endsem&endyear=$endyear">Player</a>
  </th>
  <th><a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?sort=score&meth=$meth&startsem=$startsem&startyear=$startyear&endsem=$endsem&endyear=$endyear">Score</a></th>
  <th>Games <a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?sort=won&meth=$meth&startsem=$startsem&startyear=$startyear&endsem=$endsem&endyear=$endyear">Won</a>/<a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?sort=games&meth=$meth&startsem=$startsem&startyear=$startyear&endsem=$endsem&endyear=$endyear">Played</a>
  </th>
  <th><a href="http://cinema.union.rpi.edu/mahjong/scores2.cgi?sort=percent&meth=$meth&startsem=$startsem&startyear=$startyear&endsem=$endsem&endyear=$endyear">Winning Percentage</th>
 </tr>
TR
my $r = 0;
my $order;
