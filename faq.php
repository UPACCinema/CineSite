...
hesitate to ask!  Email <a href="mailto:upac-cinema@rpi.edu">upac-cinema@rpi.edu</a>,
 or stop by any of our movies to talk to an officer!
...
calling the projection booth at 518-276-6877.");
...
<?php 
  ...
  foreach ($faqs as $faq) { 
    $num++;
?>
    <li><a href="#q<?php echo $num ?>"><?php echo $faq['q'] ?></a></li>
<?php 
  }   
?>
</ol>
